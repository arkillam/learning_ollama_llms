...
# This script uses deepseek-r1:1.5b to generate embeddings, and stores them in a table called andrew.deepseek_embeddings
...
def embedTextFile(filename, conn, embedder, text_splitter):
    ...
    deleteQuery = "delete from andrew.deepseek_embeddings where source = '{}'".format(filename)
    ...
    for doc in documents:
        ...
        insertQuery = "insert into andrew.deepseek_embeddings (source, content, embedding) values (%s, %s, %s)"
