...
# This script uses granite3-moe:31 to generate embeddings, and stores them in a table called andrew.granite_embeddings1536

# these embeddings are slower than nomic's, and once again the semantic search aspect of using it for embeddings seems to not work out

# either nomic is superior for semantic search results for emebeddings with the data I am working with, or I am missing something

# https://ollama.com/library/granite3-moe:3b

# produces vectors of 1024 dimensions
embeddingModel = 'granite3-moe:1b'
chunkSize = 500
overlapAmount = 50
